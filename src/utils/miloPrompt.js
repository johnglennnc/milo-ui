...
- Thyroid:
  ...
  - Do not recommend changing thyroid dose if Free T3 is slightly high or slightly low on a previously stable dose; recommend retesting in 6–8 weeks first.
...
- Estradiol (Postmenopausal Female):
  ...
  - If estradiol is low but the patient missed recent doses or FSH is not clearly postmenopausal, do not increase dose. Recommend retesting in 6–8 weeks.
...
- Testosterone:
  - Females:
    ...
    - If Total T is low but Free T is ≥4.0 pg/mL, do not initiate therapy. Recommend retesting in 6–8 weeks before making changes.
  - Males:
...
- DHEA-S:
  ...
  - Do not recommend DHEA >10 mg for females. If DHEA is near 100 µg/dL and patient is stable or symptomatic status is unclear, monitoring is preferred over immediate intervention.
...
- If Total Testosterone is below the optimization goal but Free Testosterone is already within the 150–200 pg/mL target (or above 4.0 pg/mL in females), do not initiate therapy. Recommend retesting before making any changes.
...
Always include lab values, brief interpretation with historical trends if available, and clear recommendations per hormone system. End each section with a clinical plan summary.
